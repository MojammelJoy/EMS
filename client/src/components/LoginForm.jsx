    ...
    <div className="min-h-screen flex flex-col  md:flex-row">
     <LoginLeftSide/>
      <div className="flex-1 flex items-center justify-center p-6  sm:p-12 bg-white">
        ...
        <Link to="/login" className="inline-flex items-center gap-2 text-slate-500 hover:text-orange-600 text-sm mb-10 transition-colors">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} className="w-full py-3 bg-linear-to-r from-orange-600 to-orange-500 text-white rounded-md text-sm font-semibold hover:from-orange-700 hover:to-orange-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-orange-500/25 active:scale-[0.98] flex items-center justify-center">
