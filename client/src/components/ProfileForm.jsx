        ...
        <div className='space-y-5'>
            ...
            {initialData.isDeleted ? (
                ...
                <div className='flex justify-end pt-2'>
                    <button type='submit' disabled={loading} className='bg-gradient-to-r from-orange-600 to-orange-500 text-white px-5 py-2.5 rounded-md text-sm hover:from-orange-700 hover:to-orange-600 transition-all shadow-md shadow-orange-500/25 active:scale-[0.98]  flex items-center gap-2 justify-center w-full sm:w-auto'>
