    ...
    <div className="animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5">
          {filtered.length === 0 ? (
            <p className="col-span-full text-center py-16 text-slate-400 bg-white rounded-2xl border border-dashed border-slate-200">employees found</p>
          ) : (
           ...
           {showCreateModal && (
            <div className="fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto" onClick={()=>setShowCreateModal(false)}>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl w-full max-x-3xl my-8 animate-fade-in" onClick={(e)=> e.stopPropagation()}>
      ...
      {editEmployee && (
        <div className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto bg-black/40 backdrop-blue-sm" onClick={()=> setEditEmployee(null)}>
