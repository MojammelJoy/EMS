  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div className='text-center'>
        <button className='bg-gradient-to-r from-orange-600 to-orange-500 text-white px-5 py-2.5 rounded-md text-sm hover:from-orange-700 hover:to-orange-600 transition-all shadow-md shadow-orange-500/25 active:scale-[0.98] print:hidden' onClick={() => window.print()}>
          Print Payslip
        </button>
      </div>
    </div>
